      ...
      <table width="100%" id = "options">
        <thead> 
          <tr id= "steps">
            <td> Plan Type </td>                  
            <td> Base Price  </td>
            <td> AD&D <img title="Accidental Death and Dismemberment" src="http://www.free-icons-download.net/images/blue-info-button-icon-50693.png" alt="information" height="20" width="20">  </td> 
            <td> Deductible </td>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2 id="steps">Our Insurance Recommendations</h2>
          </div>
        </div>
      </div>
    </section>
